...
import SideNavBar from '../../Components/StudentsComponents/SideNavBar';

function AdTopNavBar() {
  return (
        ...
        <div>
          <Dropdown>
            <Dropdown.Toggle variant="none" id="dropdown-basic" className='text-light'>
              ...
              <span className='Profile-name text-light'>Harini</span>
            </Dropdown.Toggle>
