...
import InSideNavBar from '../../../src/Components/InstructorComponents/InSideNavBar';

function InTopNavBar() {
  return (
        ...
        <div>
          <Dropdown>
            <Dropdown.Toggle variant="none" id="dropdown-basic" className='text-light'>
              ...
              <span className='Profile-name text-light'>Instructor</span>
            </Dropdown.Toggle>
