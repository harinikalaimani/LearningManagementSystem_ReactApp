...
import Page_heading from '../../StudentsComponents/Page-heading';
import { useSelector, useDispatch } from 'react-redux';
import { getUsersFromServer } from '../../../Slice/userslice';
import EditProfileModal from '../../../../src/Components/InstructorComponents/InsProfile/EditProfileModal';
...
function InsProfile() {
  ...
  const user = usersList && usersList.length > 0 ? usersList[1] : null;
